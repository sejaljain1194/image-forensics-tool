...
class ImageObject(object):
    ...
    def __init__(self, imageName, blockDimension):
        """
        ...
        self.imageOutputDirectory = "output"
        print imageName
        ...
        self.imageData = Image.open(imageName)
    ...
    def reconstruct(self):
        ...
        scipy.misc.imsave(timeStamp + "_" + self.imagePath, groundtruthImage)
        scipy.misc.imsave(timeStamp + "_lined_" + self.imagePath, linedImage)
        scipy.misc.imshow(linedImage)
     
        return timeStamp + "_lined_" + self.imagePath
